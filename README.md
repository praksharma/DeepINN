...
> [!NOTE]
> The project is going through a renaming process. There may be inconsistencies in the repo resulting in module not found errors.
...
[Margam](https://github.com/praksharma/Margam) is a deep-learning framework for solving forward  and inverse problem involving PDEs using physics-informed neural networks (PINNs).
